...
from account_app.views import CreateAdminView, AdminProfileView, AdminProfileUpdateView, AdminDeleteView, CustomLoginView
...
urlpatterns = [
	...
	path('login', CustomLoginView.as_view(template_name='account_app/login.html'), name='login'),
